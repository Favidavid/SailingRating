      ...
      for sailor_key, sailor in team['skipper'].iteritems():
        ...
        for race_number in races_sailed:
          if race_number < number_of_races:
            race_result_object = create_race_result(sailor_object,race_number,scores[team_key][div_key][race_number],div_key,number_of_teams,race_objects)
...
def create_race_result(skipper,race_number,finish_place,division,number_of_teams,race_objects):
  race_result = RaceResult(skipper,race_number,finish_place,finish_value(finish_place,number_of_teams),
